...
const BentoCard = ({
  ...
  return (
    <Link href={path} className="block">
      <div
        className={cn(
          "group relative w-40 sm:w-48 md:w-72 lg:w-80 h-44 md:h-60 lg:h-60  rounded-2xl bg-neutral-900 text-white transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl p-3",
