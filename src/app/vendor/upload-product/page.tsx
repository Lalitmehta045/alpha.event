...
import { addVendorProduct } from "@/services/operations/vendorProduct";
...
const UploadProduct: React.FC = () => {
              ...
              if (blob) {
                ...
                try {
                  ...
                  if (response.data.success) {
                    ...
                    try {
                      const signedUrlResponse = await axios.get(`/api/vendor/product/preview-image?key=${encodeURIComponent(s3Key)}`);
  ...
  const onSubmit = async (values: ProductFormValues) => {
    ...
    try {
      ...
      const result = await addVendorProduct(formattedData, token);
